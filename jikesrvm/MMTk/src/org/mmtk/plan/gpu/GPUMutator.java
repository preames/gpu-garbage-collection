 ...
 */
@Uninterruptible
public class GPUMutator extends StopTheWorldMutator {

  /****************************************************************************
   * Instance fields
   */
  protected MarkSweepLocal ms = new MarkSweepLocal(GPU.msSpace);
  ...
  public Address alloc(int bytes, int align, int offset, int allocator, int site) {
    if (allocator == GPU.ALLOC_DEFAULT) {
  ...
  public void postAlloc(ObjectReference ref, ObjectReference typeRef,
    ...
    if (allocator == GPU.ALLOC_DEFAULT)
      GPU.msSpace.postAlloc(ref);
    else
      super.postAlloc(ref, typeRef, bytes, allocator);

    GPU.allocateRefSpaceNode(ref);
  }
  ...
  public Allocator getAllocatorFromSpace(Space space) {
    if (space == GPU.msSpace) return ms;
