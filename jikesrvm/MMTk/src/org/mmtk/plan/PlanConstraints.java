...
@Uninterruptible public abstract class PlanConstraints {
  /** @return True if this Plan requires notification on java.lang.reference _referent changes. */
  public boolean needsJavaLangReferenceUpdateNotify() { return false; }

  /** @return True if the compiler should handle reference graph updates when possible (for GPU) */
  public boolean doCompiledReferenceGraphUpdates() { return false; }
