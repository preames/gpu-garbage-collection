...
public class Barriers implements org.mmtk.utility.Constants {
  ...
  /** (for GPU) True if the compiler should handle reference graph updates when possible */
  public static final boolean  DO_COMPILED_REF_GRAPH_UPDATES     = Selected.Constraints.get().doCompiledReferenceGraphUpdates();
